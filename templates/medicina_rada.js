// Auto-extracted from n8n workflow IHih9F5wsgp0pk3M (Opsis - Email Sequence v5 - Medicina rada)
// Industry: medicina_rada
module.exports = {
  E1: {
    V1: {
...
vidim da {{website}} trenutno vraca gresku ({{website_status}}). Tvrtke koje Vas Googlaju ("medicina rada {{Grad}}", "sistematski pregled {{Grad}}") trenutno samo dobivaju prazan ekran - a HR-ovi i poslovode obicno odmah zovu sljedecu ustanovu na popisu jer im pregledi moraju biti organizirani za odredeni datum.
...
slucajno sam naletio na Vas Google Business profil dok sam trazio medicinu rada u {{Grad}}u - {{review_count}} recenzija, ocjena {{review_rating}}, sve stvari koje HR odjelima i poslovodama ulijevaju povjerenje kad biraju gdje slati zaposlenike.

Primijetio sam jednu malu stvar koja Vam moze privuci vise upita od firmi (a posebno povratnih klijenata) bez ikakvog troska:

Google profil ima sekciju "Postovi" koju vecina ordinacija medicine rada uopce ne koristi. Google penalizira profile bez recentnih postova - ako nista ne objavljujete tjednima, profil pada u rangu za lokalne pretrage tipa "medicina rada {{Grad}}" i "sistematski pregled za firmu {{Grad}}".

Sto treba: 1 post tjedno, ne mora biti dug. Primjeri:
- "Sto firma treba pripremiti prije sistematskog pregleda" (lista zaposlenih, procjena opasnosti - smanjuje rutinske pozive)
- Mini-edukacija ("razlika izmedu sistematskog, periodicnog i sanitarnog pregleda")
- Obavijest o slobodnim grupnim terminima ovaj/sljedeci mjesec
- Sezonski podsjetnik ("sezona sistematskih pregleda" prije ljetne pauze)

Postavlja se za 2 minute preko Google Business aplikacije na mobitelu. Razlika obicno vidljiva za 2-3 tjedna - vise konkretnih upita firmi koje vec znaju sto im treba.
...
otvorio sam {{website}} u Chromeu i odmah dobio upozorenje "Veza nije sigurna". Razlog: stranica nema HTTPS (SSL certifikat). Za medicinu rada to je osjetljivo jer firme cesto salju liste zaposlenih i podatke o radnim mjestima - "Veza nije sigurna" odmah ih natjera da nazovu konkurenciju.
...
Sitemap je tekstualni fajl koji govori Googleu "evo svih stranica koje imam, indeksiraj ih". Bez njega Google sam pogada sto imate, i obicno propusti pola stranica - sto je steta, jer bas stranice o vrstama pregleda i ponudi za firme su one koje HR-ovi traze kad odlucuju s kim raditi.

Generirao sam okvirni sitemap za Vasu ustanovu, kopirajte u obican tekst editor, snimite kao "sitemap.xml":

  <?xml version="1.0" encoding="UTF-8"?>
  <urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
    <url><loc>{{website}}/</loc><priority>1.0</priority></url>
    <url><loc>{{website}}/pregledi</loc><priority>0.9</priority></url>
    <url><loc>{{website}}/firme</loc><priority>0.9</priority></url>
    <url><loc>{{website}}/cjenik</loc><priority>0.8</priority></url>
    <url><loc>{{website}}/dokumenti</loc><priority>0.8</priority></url>
...
Ako imate i posebne stranice (rad na visini, sanitarni pregledi, vozaci, izlozenost buci/kemikalijama), javite ih, pa Vam prilagodim sitemap.
...
- Ne znate koliko firmi i pojedinaca mjesecno dolazi na stranicu
- Ne znate odakle dolaze (Google, preporuka knjigovode, direktno...)
- Ne znate koje informacije najvise traze (cjenik za firme, vrste pregleda, dokumentacija, grupni dolasci)
...
Napomena: GA4 ne prati osobne zdravstvene podatke, samo agregirani saobracaj - kompatibilno s GDPR-om uz standardni cookie banner. Ne vidi tko je tko, samo "30 firmi je danas doslo na stranicu cjenika".

Za 24-48h imat cete prve podatke. Najkorisnije: vidite koje vrste pregleda firme najvise traze (sistematski, rad na visini, vozaci) - pa Vam to pomaze odluciti gdje povecati kapacitet ili koje pakete istaknuti.
...
Ne zelite vise dobivati ove mailove? Odgovorite "STOP HRVATSKA".`
    ...
    V6: {
      subject: `WhatsApp odgovori za firme i sistematske preglede`,
      body: `Pozdrav,

pretpostavljam da Vam HR osobe iz firmi salju upite preko mejla, telefona i WhatsAppa, i da se kroz dan ponavljaju ista pitanja: "Sto treba dostaviti prije pregleda?", "Imate li paket za 15 zaposlenih?", "Mozete li doci k nama u firmu?". Vecina HR-ova preferira pisanu komunikaciju jer im je lakse proslijediti odgovor unutar firme.

WhatsApp Business aplikacija ima sekciju "Quick Replies" koja Vam organizaciju moze jako ubrzati. Evo 4 gotova odgovora koje mozete kopirati i koristiti:

1) Onboarding firme / prvi upit (kracenica: /firma-upit)
"Pozdrav, hvala sto razmisljate o nama. Da pripremimo prijedlog, molim 3 stvari: 1) Broj zaposlenih koje treba pregledati? 2) Vrsta posla / klasifikacija opasnosti (npr. uredska, proizvodnja, gradevinski poslovi, rad na visini, vozaci)? 3) Zeljeni datum ili raspon datuma? Na osnovu toga saljemo pisanu ponudu u istom danu."

2) Paketi i vrste pregleda (kracenica: /paketi)
"Nase glavne vrste pregleda: Sistematski pregled X EUR po zaposlenom, Sanitarni pregled Y EUR (za rad s hranom), Pregled za rad na visini Z EUR, Pregled za vozace W EUR. Za grupe iznad 10 zaposlenih: paket popust. Za tocnu kalkulaciju saljemo pisanu ponudu nakon sto saznamo strukturu radnih mjesta."

3) Dokumentacija koju firma dostavlja (kracenica: /dokumentacija)
"Prije pregleda firma dostavlja: 1) Lista zaposlenih (ime, prezime, OIB, radno mjesto). 2) Procjenu opasnosti za svako radno mjesto (moze i izvod iz Akta o procjeni opasnosti). 3) Kontakt osobu iz firme (HR ili strucnjak ZNR). 4) Eventualno postojece zdravstvene kartone ako su iz druge ustanove. Sve moze mailom ili putem WhatsApp dokumenata."

4) Grupni termini i dolasci u firmu (kracenica: /termini-grupa)
"Za 5-20 zaposlenih: bulk booking u nasoj ordinaciji u istom danu (skraceni dolasci po pojedincu). Za 20+ zaposlenih: dolazimo k Vama u firmu (mobilna ekipa s opremom) - minimaliziramo gubitak radnog vremena. Mobilni pregledi obicno traju 1-2 radna dana zavisno o broju i vrsti pregleda."

Postavlja se za 5 minuta: WhatsApp Business → Settings → Business tools → Quick replies → Add new.

Bonus: dodajte na Google profil link na WhatsApp s tekstom "Posaljite upit za firmu" - HR-ovi vole sto ne moraju zvati i cekati.
...
testirao sam {{website}} kroz Google PageSpeed Insights - mobile rezultat je {{pagespeed_mobile}}/100. Sve ispod 50 znaci da posjetitelji cekaju 4-6 sekundi da se stranica ucita, a 53% ljudi odustane prije nego sto se uopce prikaze (Google podatak). HR-ovi obicno istrazuju s mobitela izmedu sastanaka - ako se ne otvori brzo, nazovu sljedecu ustanovu.

3 stvari koje obicno najvise ubrzaju (lako za napraviti):

1) Komprimirajte slike
   Idite na tinypng.com, uploadajte sve slike s Vase stranice (fotografije tima, prostora, opreme), downloadajte komprimirane verzije, zamijenite original. Obicno smanji slike za 60-70% bez vidljivog gubitka kvalitete.
...
3) Aktivirajte browser caching
   ...
   Tako returning posjetitelji (HR osobe iz firmi koje se vracaju provjeriti ponudu ili dokumentaciju) ne moraju ponovno ucitavati slike.
...
primijetio sam jednu malu stvar na {{website}} koja utjece na to kako Vasa stranica izgleda kad se pojavi u Google rezultatima ili kad netko podijeli link (npr. HR koji prosljeduje upravi prijedlog gdje slati zaposlenike na sistematske).
...
- Kad netko podijeli Vas link (npr. u korporativnom Slacku ili Teamsu), prikaze se prazno bez slike i opisa
- Nemate "rich snippets" (zvjezdice, ocjene) u Google rezultatima - sto HR odjelima signalizira povjerenje

Napisao sam Vam gotove tagove, samo paste u <head> sekciju HTML-a:

  <!-- Meta description za Google -->
  <meta name="description" content="{{title}} - medicina rada u {{Grad}}u. {{review_count}}+ recenzija, ocjena {{review_rating}}/5. Sistematski i specijalisticki pregledi za firme. Kontakt: {{phone}}.">

  <!-- Open Graph (za Facebook/WhatsApp/LinkedIn share) -->
  <meta property="og:title" content="{{title}} - medicina rada {{Grad}}">
  <meta property="og:description" content="Medicina rada u {{Grad}}u, {{review_count}}+ zadovoljnih klijenata. Sistematski, sanitarni, periodicni pregledi. Grupni dolasci za firme.">
  ...
  <script type="application/ld+json">
  {
    ...
    "url": "{{website}}",
    "telephone": "{{phone}}",
    "medicalSpecialty": "https://schema.org/Occupational",
    "address": {
      "@type": "PostalAddress",
...
Ne zelite vise dobivati ove mailove? Odgovorite "STOP HRVATSKA".`
    ...
    V9: {
      subject: `5 sitnica za bolji broj upita firmi`,
      body: `Pozdrav,

prosetao sam Vasom stranicom {{website}} - sve izgleda solidno tehnicki (brzina, SEO, HTTPS, struktura). Bravo, vidi se rad iza toga.

Posto je tehnicka strana poslozena, evo 5 sitnica koje obicno pomazu medicini rada dobiti vise konkretnih upita firmi i smanjiti rutinske pozive iz iste kolicine prometa:

1) Telefonski broj klikabilan na mobitelu
   U HTML-u broj treba biti zamotan u <a href="tel:{{phone_clean}}">{{phone}}</a> - kad HR osoba s mobitela klikne, otvara dial direktno. Tipicno 10-20% vise poziva ako trenutno nije klikabilan.

2) WhatsApp click button s privacy disclaimerom
   Dodajte negdje vidljivo na stranicu:
   <a href="https://wa.me/{{phone_intl}}?text=Pozdrav,%20trebam%20ponudu%20za%20firmu">Posaljite upit za firmu na WhatsApp</a>
   Ispod sitnim slovima: "Podaci o zaposlenima salju se nakon potpisa povjerljivosti." HR-ovi vole sto mogu poslati brzo bez cekanja na liniji.

3) Online booking widget za grupne dolaske
   Calendly (medical edition) podrzava grupne rezervacije - HR ulazi, bira datum, broj zaposlenih, vrstu pregleda. Stigne Vam vec strukturiran upit. Conversion rate +25-40% testirano (Hotjar 2024 data).

4) Trust signali iznad fold-a (prvih 600px stranice)
   "Ovlasteni specijalist medicine rada", "{{review_count}}+ recenzija", "{{review_rating}}/5 Google", broj godina prakse, broj zaposlenih iz partner firmi godisnje. Smanjuje bounce za ~15%, posebno za nove HR osobe koje istrazuju.

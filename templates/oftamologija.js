// Auto-extracted from n8n workflow 7KiZyebnLENkxefr (Opsis - Email Sequence v5 - Oftalmoloske ordinacije)
// Industry: oftamologija
module.exports = {
  E1: {
    V1: {
...
vidim da {{website}} trenutno vraca gresku ({{website_status}}). Pacijenti koji Vas Googlaju za ocni pregled, kontrolu vida ili termin trenutno samo dobivaju prazan ekran - sto je narocito problematicno jer kod oftalmoloskih ordinacija pacijenti cesto traze "ocni pregled {{Grad}}" u trenutku kad im je vid vec smetnja.
...
slucajno sam naletio na Vas Google Business profil dok sam trazio oftalmologa u {{Grad}}u - {{review_count}} recenzija, ocjena {{review_rating}}, sve stvari koje pacijentima ulijevaju povjerenje.

Primijetio sam jednu malu stvar koja Vam moze smanjiti broj telefonskih poziva s pitanjima o terminima i cijenama za 30-40% bez ikakvog troska:

Google profil ima sekciju "Postovi" (slicno kao Facebook postovi) koju vecina ordinacija uopce ne koristi. Google penalizira profile bez recentnih postova - ako nista ne objavljujete tjednima, profil pada u rangu za lokalne pretrage tipa "ocni pregled {{Grad}}" ili "oftalmolog {{Grad}}".

Sto treba: 1 post tjedno ili dva tjedno, ne mora biti dugacak. Primjeri za oftalmolosku ordinaciju:
- Sezonski podsjetnik ("Vrijeme za godisnji pregled vida - termini otvoreni za rujan")
- Informacija o pregledu djece ("Pregled prije polaska u skolu - preporucamo do kraja kolovoza")
- Obavijest o novoj opremi ili dijagnostici (OCT, biometrija, autorefraktometar)
- Edukativni post (npr. simptomi katarakte, kada na pregled)

Postavlja se za 2 minute preko Google Business aplikacije na mobitelu. Sigurno cete primijetiti razliku za 2-3 tjedna - manje rutinskih poziva u recepciju, vise pripremljenih pacijenata.
...
otvorio sam {{website}} u Chromeu i odmah dobio upozorenje "Veza nije sigurna". Razlog: stranica nema HTTPS (SSL certifikat). Za zdravstvene stranice je to dvostruko bitno jer pacijenti koji vide upozorenje na ordinaciji pretpostavljaju da nesto drugo nije u redu - povjerenje se gradi i u takvim sitnicama.
...
Sitemap je tekstualni fajl koji govori Googleu "evo svih stranica koje imam, indeksiraj ih". Bez njega Google sam pogada sto imate, i obicno propusti pola stranica - sto je problem za oftalmoloske ordinacije jer pacijenti specificno traze "operacija katarakte {{Grad}}", "pregled vida djeca {{Grad}}", a te podstranice trebaju biti vidljive Googleu.
...
Generirao sam okvirni sitemap za Vasu ordinaciju, kopirajte u obican tekst editor, snimite kao "sitemap.xml":
  ...
  <urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
    ...
    <url><loc>{{website}}/djeca</loc><priority>0.9</priority></url>
...
Ako imate vise stranica od ovih u primjeru (npr. posebne za refraktivnu kirurgiju, OCT dijagnostiku, kontaktne lece, partner optike), javite ih, pa Vam prilagodim sitemap.
...
- Ne znate odakle dolaze (Google pretraga, preporuka, partner optika, direktno...)
- Ne znate koja usluga (pregled, djecji pregledi, operacije) najvise privlaci pacijente
- Ako pokrenete oglase na Facebooku ili Googleu, ne mozete optimizirati jer alati ne vide tko je zapravo zakazao pregled
...
Za 24-48h imat cete prve podatke o tome koja vrsta pacijenata (po dobnim skupinama, regiji, uslugama koje traze) najvise dolazi.
...
opsisdalmatia.com`
    ...
    V6: {
      subject: `WhatsApp Quick Replies za ocne preglede`,
      body: `Pozdrav,

pretpostavljam da telefoni u ordinaciji znaju biti optereceni, posebno na pocetku skolske godine i ujutro izmedu 8-10. Vecina poziva su ista pitanja: "Koliko kosta pregled?", "Imate li slobodno za dijete?", "Trebam li uputnicu?", "Radite li i operacije?". Recepcija trosi sate na rutinske odgovore umjesto na pacijente u cekaonici.

WhatsApp Business aplikacija ima sekciju "Quick Replies" koja vecini to rijesi - pacijent pise umjesto zove, recepcija odgovara u pauzi. Evo 4 gotova odgovora koje mozete kopirati:

1) Pregled i cjenik (kracenica: /pregled)
"Pozdrav. Standardni pregled vida (ostrina, intraokularni tlak, pregled retine): {X EUR}. Pregled djece: {Y EUR}. Detaljnija dijagnostika (OCT, biometrija, ultrazvuk): {Z EUR}. Bez uputnice. Za termin posaljite ime i 2-3 termina koja Vam odgovaraju."

2) Dioptrija i recepti (kracenica: /diopter)
"Recept za naocale dobivate odmah nakon pregleda, vrijedi 1-2 godine ovisno o stabilnosti dioptrije. Suradujemo s partner optikama u {{Grad}}u - nasi pacijenti dobivaju popust na okvire i lece uz nasu uputnicu. Lista optika dostupna na recepciji."

3) Pregledi djece (kracenica: /djeca)
"Prvi pregled vida preporucamo s 3-5 godina (prevencija ambliopije). Od 6-10g preporucamo godisnji pregled jer u toj dobi se najcesce razvija miopija. Pregled djece ukljucuje: refrakciju, stereotest, pokretljivost oka, pregled prednjeg segmenta. Traje 30-45 min."

4) Operacije i refraktivna kirurgija (kracenica: /operacija)
"Konzultacija prije refraktivne operacije (LASIK, PRK, fakicne lece) je besplatna. Dijagnostika koja se radi prije zahvata (topografija, biometrija, pahimetrija): {Y EUR}. Za operacije katarakte suradujemo s KBC-om - mozemo Vas uputiti s pripremnom dokumentacijom."

Postavlja se za 5 minuta: WhatsApp Business ? Settings ? Business tools ? Quick replies ? Add new.

Bonus: dodajte WhatsApp broj na Google profil - manje propustenih poziva u peak satima i pacijenti mogu pitati i navecer kad recepcija nije aktivna.
...
testirao sam {{website}} kroz Google PageSpeed Insights - mobile rezultat je {{pagespeed_mobile}}/100. Sve ispod 50 znaci da pacijenti cekaju 4-6 sekundi da se stranica ucita, a 53% ljudi odustane prije nego sto se uopce prikaze (Google podatak). Za zdravstvene stranice je to posebno bolno jer pacijenti cesto traze ordinaciju u trenutku kad im je vec nesto smetnja - i odustaju brze od obicnih korisnika.

3 stvari koje obicno najvise ubrzaju (lako za napraviti):

1) Komprimirajte slike
   Idite na tinypng.com, uploadajte sve slike s Vase stranice (fotografije ordinacije, opreme, tima), downloadajte komprimirane verzije, zamijenite original. Obicno smanji slike za 60-70% bez vidljivog gubitka kvalitete.
...
3) Aktivirajte browser caching
   ...
   Tako returning pacijenti ne moraju ponovno ucitavati slike.
...
primijetio sam jednu malu stvar na {{website}} koja utjece na to kako Vasa stranica izgleda kad se pojavi u Google rezultatima ili kad netko podijeli link na Facebooku/WhatsAppu (npr. pacijent koji preporucuje Vasu ordinaciju roditeljima).
...
- Nemate "rich snippets" (zvjezdice, ocjene) u Google rezultatima - sto novim pacijentima signalizira povjerenje, posebno bitno kod medicinskih usluga

Napisao sam Vam gotove tagove, samo paste u <head> sekciju HTML-a:

  <!-- Meta description za Google -->
  <meta name="description" content="{{title}} - oftalmoloska ordinacija u {{Grad}}u. {{review_count}}+ recenzija, ocjena {{review_rating}}/5. Zakazivanje pregleda na {{phone}}.">

  <!-- Open Graph (za Facebook/WhatsApp/LinkedIn share) -->
  <meta property="og:title" content="{{title}} - oftalmolog {{Grad}}">
  <meta property="og:description" content="Oftalmoloska ordinacija u {{Grad}}u, {{review_count}}+ zadovoljnih pacijenata.">
...
Paste sve u <head> nakon <title> taga. Za "cover.jpg" upload sliku ordinacije ili logotip u root domena (ili promijenite path u onaj koji imate). Velicina 1200x630px ide najbolje.
...
Posto je tehnicka strana poslozena, evo 5 sitnica koje obicno pomazu oftalmoloskim ordinacijama dobiti vise organiziranih termina i manje no-show iz iste kolicine prometa:
...
2) WhatsApp click button uz napomenu o privatnosti
   Dodajte negdje vidljivo na stranicu:
   <a href="https://wa.me/{{phone_intl}}?text=Pozdrav,%20zanima%20me%20termin%20za%20pregled">Zakazi pregled na WhatsAppu</a>
   Dodajte uz dugme malu napomenu "Za zakazivanje termina. Medicinske dijagnoze ne dajemo putem poruka." - pacijenti cijene jasne granice, smanjuje rizik od osjetljive komunikacije.
...
4) Trust elementi iznad fold-a
   "{{review_count}}+ recenzija", "{{review_rating}}/5 Google", godine iskustva, broj lijecnika u timu, certifikati (Komora, ESCRS, EUREYE). Smanjuje bounce za ~15%, posebno za nove pacijente kojima je medicinsko povjerenje presudno.

5) Edukativni sadrzaj kao SEO motor
   Stranice tipa "Kada na prvi pregled vida djeteta", "Sto ocekivati nakon operacije katarakte", "Razlika izmedu LASIK i PRK" - pacijenti to traze na Googleu prije bilo kakvog poziva. Svaka takva stranica dovodi promet tijekom godina, a kad ih pise strucna osoba dize autoritet domena u Google ocima.

Sve to mozete sami implementirati u par sati (osim edukativnih tekstova koje treba pisati postupno). Razlika vidljiva 2-4 tjedna.
